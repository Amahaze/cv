...
const ServicesSection = styled.section`
  padding: 8rem 0;
  background: linear-gradient(135deg, #6B48FF 0%, #1DCCE7 50%, #FF5E62 100%);
  position: relative;
  overflow: hidden;
  margin-top: -50px;
  ...
  &::after {
    ...
    width: 100%;
    height: 100%;
    background-image: url('data:image/svg+xml,<svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><circle cx="2" cy="2" r="1" fill="rgba(255,255,255,0.15)"/></svg>');
    opacity: 0.5;
    pointer-events: none;
  }
`;
...
const QuoteSection = styled.section`
  ...
  text-align: center;
  overflow: hidden;
  background: url('/star-4773_256.gif');
  ...
  &::after {
    ...
    width: 100%;
    height: 100%;
    background-image: url('/star-4773_256.gif');
    background-size: cover;
    background-position: center;
