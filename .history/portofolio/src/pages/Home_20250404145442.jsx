...
const ServicesSection = styled.section`
  ...
  &::before {
    ...
    width: 100%;
    height: 100%;
    background: linear-gradient(180deg, rgba(0,0,0,0.3) 0%, rgba(0,0,0,0) 10%, rgba(0,0,0,0) 90%, rgba(0,0,0,0.3) 100%);
    pointer-events: none;
  }
`;
...
const fadeInUp = {
  ...
  visible: { opacity: 1, y: 0, scale: 1, transition: { duration: 1.5, ease: [0.6, 0.01, -0.05, 0.95], type: "spring", stiffness: 100, damping: 20 } }
};
