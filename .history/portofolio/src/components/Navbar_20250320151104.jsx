...
const NavContainer = styled.nav`
  ...
  background: linear-gradient(
    ...
    ${props => `${props.theme.colors.primary}ff`} 20%,
    ${props => `${props.theme.colors.primary}f0`} 40%,
    ${props => `${props.theme.colors.primary}d0`} 60%,
    ${props => `${props.theme.colors.primary}80`} 80%,
