...
const Logo = styled(motion(Link))`
  ...
  background: ${props => props.isScrolled ? 'none' : 'linear-gradient(45deg, #000 0%, #fff 50%, #000 100%)'};
  background-size: 200% 200%;
  -webkit-background-clip: ${props => props.isScrolled ? 'none' : 'text'};
  -webkit-text-fill-color: ${props => props.isScrolled ? '#fff' : 'transparent'};
  text-shadow: ${props => props.isScrolled ? '0 0 10px rgba(255, 255, 255, 0.3)' : 'none'};
...
const NavItem = styled(motion.div)`
  ...
  background: ${props => props.isScrolled ? '#F2F0E6' : 'transparent'};
  ...
  &:hover {
    ...
    box-shadow: ${props => props.isScrolled ? '0 4px 15px rgba(0, 0, 0, 0.2)' : 'none'};
  }
...
const NavLink = styled(Link)`
  ...
  position: relative;
  z-index: 2;
  color: ${props => props.isScrolled ? '#000' : 'inherit'};
  background: ${props => props.isScrolled ? 'none' : 'linear-gradient(45deg, #fff 0%, #000 50%, #fff 100%)'};
  background-size: 200% 200%;
  -webkit-background-clip: ${props => props.isScrolled ? 'none' : 'text'};
  -webkit-text-fill-color: ${props => props.isScrolled ? '#000' : 'transparent'};
  text-shadow: none;
