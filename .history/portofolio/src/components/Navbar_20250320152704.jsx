...
const NavItem = styled.div`
  ...
  &.active {
    ...
    border-image: linear-gradient(45deg, ${props => props.theme.colors.accent}, ${props => props.theme.colors.primary}) 1;
  }
`;
...
const NavLink = styled(Link)`
  ...
  ${NavItem}:hover & {
    ...
    background: linear-gradient(45deg, ${props => props.theme.colors.accent} 0%, #fff 50%, ${props => props.theme.colors.accent} 100%);
    background-size: 200% 200%;
    -webkit-background-clip: text;
    -webkit-text-fill-color: transparent;
    animation: gradientShift 3s ease infinite;
