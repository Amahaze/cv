...
const NavItem = styled.div`
  ...
  &:hover {
    ...
    animation: borderPrismHover 3s cubic-bezier(0.4, 0, 0.2, 1) infinite;
  }

  @keyframes borderPrismHover {
    0% { border-image: linear-gradient(45deg, #ff0000, #00ff00, #0000ff) 1 }
    25% { border-image: linear-gradient(45deg, #0000ff, #ff0000, #00ff00) 1 }
    50% { border-image: linear-gradient(45deg, #00ff00, #0000ff, #ff0000) 1 }
    75% { border-image: linear-gradient(45deg, #ff0000, #00ff00, #0000ff) 1 }
    100% { border-image: linear-gradient(45deg, #0000ff, #ff0000, #00ff00) 1 }
  }
`;
