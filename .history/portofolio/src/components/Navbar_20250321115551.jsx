...
const NavItem = styled.div`
  ...
  @keyframes borderPrism {
    0% { border-image: linear-gradient(45deg, #fff, transparent, #000, transparent, #fff) 1 }
    25% { border-image: linear-gradient(45deg, #000, #fff, transparent, #fff, #000) 1 }
    50% { border-image: linear-gradient(45deg, #fff, transparent, #fff, transparent, #fff) 1 }
    75% { border-image: linear-gradient(45deg, #000, #fff, transparent, #fff, #000) 1 }
    100% { border-image: linear-gradient(45deg, #fff, transparent, #000, transparent, #fff) 1 }
  }
