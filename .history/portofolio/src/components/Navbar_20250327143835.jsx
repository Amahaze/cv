...
const Logo = styled(motion(Link))`
  ...
  z-index: 2;
  padding: 0.2em 0.4em;
  color: ${({ isServicesSection }) => isServicesSection ? '#fff' : 'inherit'};
  background: ${({ isAboutPage, isServicesSection }) => 
    isServicesSection
      ? 'none'
      : isAboutPage 
  ...
  -webkit-background-clip: ${({ isServicesSection }) => isServicesSection ? 'none' : 'text'};
  -webkit-text-fill-color: ${({ isServicesSection }) => isServicesSection ? '#fff' : 'transparent'};
  text-shadow: none;
  animation: ${({ isServicesSection }) => isServicesSection ? 'none' : 'gradientShift 6s cubic-bezier(0.4, 0, 0.2, 1) infinite'};
...
const NavItem = styled(motion.div)`
  ...
  overflow: hidden;
  border-radius: ${({ isServicesSection }) => isServicesSection ? '20px' : '4px'};
  background: ${({ isServicesSection }) => isServicesSection ? '#fff' : 'transparent'};
  ...
  animation: ${({ isServicesSection }) =>
    isServicesSection ? 'none' : 'borderPrism 6s cubic-bezier(0.4, 0, 0.2, 1) infinite'};
...
const NavLink = styled(Link)`
  ...
  background-size: 200% 200%;
  -webkit-background-clip: ${({ isServicesSection }) => isServicesSection ? 'none' : 'text'};
  -webkit-text-fill-color: ${({ isServicesSection }) => isServicesSection ? '#4B0082' : 'transparent'};
  text-shadow: none;
  animation: ${({ isServicesSection }) => isServicesSection ? 'none' : 'gradientShift 6s cubic-bezier(0.4, 0, 0.2, 1) infinite'};
