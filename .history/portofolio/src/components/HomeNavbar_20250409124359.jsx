...
const NavContainer = styled(motion.nav)`
  ...
  right: 0;
  z-index: 100;
  background: ${props => props.isScrolled ? 'rgba(255, 255, 255, 0.95)' : 'linear-gradient(to bottom, #000 80%, rgba(0, 0, 0, 0))'};  
...
const Logo = styled(motion(Link))`
  ...
  position: relative;
  z-index: 2;
  color: ${props => props.isScrolled ? '#4B0082' : '#000'};
  background: ${props => props.isScrolled ? 'transparent' : 'linear-gradient(45deg, #000 0%, #fff 50%, #000 100%)'};
  background-size: 200% 200%;
  -webkit-background-clip: ${props => props.isScrolled ? 'none' : 'text'};
  -webkit-text-fill-color: ${props => props.isScrolled ? '#4B0082' : 'transparent'};
  text-shadow: ${props => props.isScrolled ? '0 2px 4px rgba(75, 0, 130, 0.2)' : 'none'};
  padding: 0.2em 0.4em;
...
const NavItem = styled(motion.div)`
  ...
  background: ${props => props.isScrolled ? '#4B0082' : 'transparent'};
  ...
  &:hover {
    ...
    color: ${props => props.isScrolled ? '#4B0082' : 'inherit'};
  }
  ...
  &:hover {
    ...
    background: ${props => props.isScrolled ? '#fff' : 'transparent'};
    color: ${props => props.isScrolled ? '#4B0082' : 'inherit'};
    box-shadow: ${props => props.isScrolled ? '0 4px 15px rgba(75, 0, 130, 0.3)' : 'none'};
  }
`;
...
const NavLink = styled(Link)`
  ...
  &.active {
    background: ${props => props.isScrolled ? '#4B0082' : 'linear-gradient(45deg, #000 0%, #fff 50%, #000 100%)'};
    background-size: 200% 200%;
    -webkit-background-clip: ${props => props.isScrolled ? 'none' : 'text'};
    -webkit-text-fill-color: ${props => props.isScrolled ? '#fff' : 'transparent'};
    text-shadow: ${props => props.isScrolled ? '0 2px 4px rgba(75, 0, 130, 0.2)' : '0 0 2px rgba(255, 255, 255, 0.7)'};
    animation: ${props => props.isScrolled ? 'none' : 'gradientShift 3s ease infinite'};
  }
`;
