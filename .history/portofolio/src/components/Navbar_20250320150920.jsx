...
const NavContainer = styled.nav`
  ...
  background: linear-gradient(
    to bottom,
    ${props => `${props.theme.colors.primary}ff`} 0%,
    ${props => `${props.theme.colors.primary}f5`} 15%,
    ${props => `${props.theme.colors.primary}ea`} 30%,
    ${props => `${props.theme.colors.primary}df`} 45%,
    ${props => `${props.theme.colors.primary}d4`} 60%,
    ${props => `${props.theme.colors.primary}c9`} 75%,
    ${props => `${props.theme.colors.primary}be`} 85%,
