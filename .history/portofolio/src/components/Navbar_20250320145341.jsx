...
const NavContainer = styled.nav`
  ...
  right: 0;
  z-index: 100;
  background: linear-gradient(45deg, ${props => props.theme.colors.primary}00, ${props => props.theme.colors.secondary}15);
  ...
  @keyframes backgroundShift {
    0% { background-position: 0% 50%; border-image: linear-gradient(to right, rgba(255,255,255,0.05), rgba(255,255,255,0.2), rgba(255,255,255,0.05)) 1; }
    50% { background-position: 100% 50%; border-image: linear-gradient(to right, rgba(255,255,255,0.2), rgba(255,255,255,0.05), rgba(255,255,255,0.2)) 1; }
    100% { background-position: 0% 50%; border-image: linear-gradient(to right, rgba(255,255,255,0.05), rgba(255,255,255,0.2), rgba(255,255,255,0.05)) 1; }
  }
  ...
  &::before {
    ...
    opacity: calc(0.3 + (var(--scroll-progress, 0) * 0.4));
    pointer-events: none;
  }
`;
...
const NavItem = styled.div`
  ...
  &:hover::before {
    ...
    animation: liquidFill 0.8s cubic-bezier(0.25, 0.8, 0.25, 1);
  }
