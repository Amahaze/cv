...
const NavItem = styled.div`
  ...
  transition: all 0.3s ease;
  animation: borderPrism 3s linear infinite;
  
  @keyframes borderPrism {
    0% { border-image: linear-gradient(45deg, #fff, #000, #fff) 1 }
    33% { border-image: linear-gradient(45deg, #000, #fff, #000) 1 }
    66% { border-image: linear-gradient(45deg, #fff, #000, #fff) 1 }
    100% { border-image: linear-gradient(45deg, #000, #fff, #000) 1 }
  }
