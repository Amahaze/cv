...
const Logo = styled(Link)`
  ...
  position: relative;
  z-index: 2;
  background: linear-gradient(45deg, #000 0%, red 30%, #fff 50%, red 70%, #000 100%);
...
const NavItem = styled.div`
  ...
  @keyframes borderPrism {
    0% { border-image: linear-gradient(45deg, #fff, red, #000) 1 }
    25% { border-image: linear-gradient(45deg, #000, #fff, red) 1 }
    50% { border-image: linear-gradient(45deg, red, #000, #fff) 1 }
    75% { border-image: linear-gradient(45deg, #fff, red, #000) 1 }
    100% { border-image: linear-gradient(45deg, #000, #fff, red) 1 }
  }
  
  &:hover {
    transform: scale(1.05);
    border-image: linear-gradient(45deg, #000, red, #fff, #000) 1;
  }
`;
