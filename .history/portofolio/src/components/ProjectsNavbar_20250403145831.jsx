...
const NavContainer = styled(motion.nav)`
  ...
  right: 0;
  z-index: 100;
  background: linear-gradient(to bottom, #4B0082 80%, rgba(75, 0, 130, 0));
...
const Logo = styled(motion(Link))`
  ...
  border-image: linear-gradient(45deg, #9400D3, #4B0082) 1;
...
const NavItem = styled(motion.div)`
  ...
  border: 2px solid transparent;
  border-image: linear-gradient(45deg, #9400D3, #4B0082, #9400D3) 1;
  ...
  &:hover {
    ...
    border-image: linear-gradient(45deg, #9400D3, #4B0082, #9400D3) 1;
    background: linear-gradient(45deg, rgba(148, 0, 211, 0.1), transparent);
...
const NavLink = styled(Link)`
  ...
  &.active {
    background: linear-gradient(45deg, #9400D3 0%, #4B0082 50%, #9400D3 100%);
    background-size: 200% 200%;
    -webkit-background-clip: text;
    -webkit-text-fill-color: transparent;
    text-shadow: 0 0 2px rgba(148, 0, 211, 0.7);
