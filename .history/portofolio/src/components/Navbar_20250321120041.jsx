...
const Logo = styled(Link)`
  ...
  position: relative;
  z-index: 2;
  background: linear-gradient(45deg, #000 0%, violet 30%, #fff 50%, violet 70%, #000 100%);
...
const NavItem = styled.div`
  ...
  @keyframes borderPrism {
    0% { border-image: linear-gradient(45deg, #fff, violet, #000) 1 }
    25% { border-image: linear-gradient(45deg, #000, #fff, violet) 1 }
    50% { border-image: linear-gradient(45deg, violet, #000, #fff) 1 }
    75% { border-image: linear-gradient(45deg, #fff, violet, #000) 1 }
    100% { border-image: linear-gradient(45deg, #000, #fff, violet) 1 }
  }
...
const NavLink = styled(Link)`
  ...
  &.active {
    background: linear-gradient(45deg, #fff 0%, violet 30%, #000 50%, violet 70%, #fff 100%);
    background-size: 200% 200%;
    -webkit-background-clip: text;
    -webkit-text-fill-color: transparent;
