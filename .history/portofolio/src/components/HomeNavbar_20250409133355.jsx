...
const NavItem = styled(motion.div)`
  ...
  border: 2px solid ${props => props.isScrolled ? '#87CEEB' : '#D3D3D3'};
  
  &:hover {
    transform: scale(1.15);
    transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1);
    background-color: ${props => props.isScrolled ? 'hsl(199, 95%, 74%)' : '#D3D3D3'};
...
const NavLink = styled(Link)`
  ...
  position: relative;
  z-index: 2;
  color: ${props => props.isScrolled ? '#87CEEB' : '#D3D3D3'};
