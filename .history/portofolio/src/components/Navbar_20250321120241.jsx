...
const NavItem = styled.div`
  ...
  @keyframes borderPrism {
    0% { border-image: linear-gradient(45deg, #fff, #000080, #000) 1 }
    25% { border-image: linear-gradient(45deg, #000, #fff, #000080) 1 }
    50% { border-image: linear-gradient(45deg, #000080, #000, #fff) 1 }
    75% { border-image: linear-gradient(45deg, #fff, #000080, #000) 1 }
    100% { border-image: linear-gradient(45deg, #000, #fff, #000080) 1 }
  }
  
  &:hover {
    transform: scale(1.05);
    border-image: linear-gradient(45deg, #000080, #fff, #000) 1;
    background: linear-gradient(45deg, #000080 0%, #fff 50%, #000 100%);
    background-size: 200% 200%;
    -webkit-background-clip: text;
    -webkit-text-fill-color: transparent;
