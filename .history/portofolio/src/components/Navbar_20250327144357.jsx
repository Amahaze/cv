...
const NavItem = styled(motion.div)`
  ...
  overflow: hidden;
  border-radius: ${({ isServicesSection }) => isServicesSection ? '50px' : '4px'};
  background: ${({ isServicesSection }) => isServicesSection ? '#9400D3' : 'transparent'};
  border: ${({ isServicesSection }) => isServicesSection ? 'none' : '2px solid transparent'};
...
const NavLink = styled(Link)`
  ...
  position: relative;
  z-index: 2;
  color: ${({ isServicesSection }) => isServicesSection ? '#FFFFFF' : 'inherit'};
  background: ${({ isAboutPage, isServicesSection }) => 
    isServicesSection
      ? 'none'
      : isAboutPage 
  ...
  -webkit-text-fill-color: ${({ isServicesSection }) => isServicesSection ? '#FFFFFF' : 'transparent'};
