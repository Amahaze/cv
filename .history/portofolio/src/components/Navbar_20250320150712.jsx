...
const NavContainer = styled.nav`
  ...
  background: linear-gradient(
    to bottom,
    ${props => `${props.theme.colors.primary}dd`} 0%,
    ${props => `${props.theme.colors.primary}aa`} 25%,
    ${props => `${props.theme.colors.primary}77`} 50%,
    ${props => `${props.theme.colors.primary}44`} 75%,
