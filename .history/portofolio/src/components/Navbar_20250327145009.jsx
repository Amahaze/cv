...
const NavContainer = styled(motion.nav)`
  ...
  background: ${({ isAboutPage, isServicesSection }) => 
    isServicesSection
      ? 'linear-gradient(to bottom, #F5F0FF 80%, rgba(245, 240, 255, 0))'
      : isAboutPage 
...
const NavItem = styled(motion.div)`
  ...
  border: 2px solid ${({ isServicesSection }) => isServicesSection ? '#6B4E71' : 'transparent'};
  ${({ isServicesSection }) => !isServicesSection && `
...
const NavLink = styled(Link)`
  ...
  position: relative;
  z-index: 2;
  color: ${({ isServicesSection }) => isServicesSection ? '#6B4E71' : 'inherit'};
  ${({ isServicesSection }) => !isServicesSection && `
