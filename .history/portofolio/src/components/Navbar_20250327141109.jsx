...
const NavContainer = styled(motion.nav)`
  ...
  animation: ${({ isServicesSection }) => isServicesSection ? 'fadeIn' : 'none'} 0.5s cubic-bezier(0.4, 0, 0.2, 1) forwards;
...
const NavItem = styled(motion.div)`
  ...
  background: ${({ isServicesSection }) => isServicesSection ? 'rgba(255, 255, 255, 0.1)' : 'transparent'};
  border: 2px solid ${({ isServicesSection }) => isServicesSection ? 'rgba(255, 255, 255, 0.2)' : 'transparent'};
  transition: all 0.3s ease;
...
const Navbar = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      // Detect Services section and update navbar style
      const servicesSection = document.querySelector('#services-section') || document.querySelector('section:nth-of-type(2)');
      if (servicesSection) {
