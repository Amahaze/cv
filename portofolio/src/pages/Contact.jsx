          ...
          <Screen>
            ...
            <ScreenBody>
              ...
              <ScreenBodyItem>
                <AppForm>
                  <AppFormGroup>
                    <AppFormControl placeholder="NAME" />
                  </AppFormGroup>
                  <AppFormGroup>
                    <AppFormControl placeholder="EMAIL" />
                  </AppFormGroup>
                  <AppFormGroup>
                    <AppFormControl placeholder="CONTACT NO" />
                  </AppFormGroup>
                  <AppFormGroup className="message">
                    <AppFormControl placeholder="MESSAGE" />
                  </AppFormGroup>
                  <AppFormGroup className="buttons">
                    <AppFormButton>CANCEL</AppFormButton>
                    <AppFormButton onClick={handleSubmit}>SEND</AppFormButton>
                  </AppFormGroup>
                </AppForm>
              </ScreenBodyItem>
            </ScreenBody>
